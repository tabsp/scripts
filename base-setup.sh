...
sudo pacman -S --noconfirm git base-devel xorg-apps xorg-server xorg-xinit neovim tmux xsel ttf-joypixels wqy-microhei ttf-jetbrains-mono fcitx5-im fcitx5-rime ninja ripgrep lazygit ranger fd fzf bat man-db alacritty neofetch
...
yay -S --noconfirm nerd-fonts-jetbrains-mono picom-jonaburg-git
